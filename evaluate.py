...
import numpy as np
from sklearn.metrics import roc_auc_score,f1_score, label_ranking_loss
...
def cal_loss(y, y_pre):
    ...
    x = roc_auc_score(y,y_pre,average='micro')
    loss.append(x)

    x = label_ranking_loss(y, y_pre)
    loss.append(x)
